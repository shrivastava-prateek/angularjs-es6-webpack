...
gulp.task('optimize', gulp.series(gulp.parallel('inject', 'test'), function() {
 ...
 */
gulp.task('build', gulp.series(gulp.parallel('optimize', 'images', 'fonts'), function() {
